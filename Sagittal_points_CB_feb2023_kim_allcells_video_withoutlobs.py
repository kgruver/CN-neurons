...
#anim.add_keyframe(0, camera=three_quarters_camera, zoom=1)
#anim.add_keyframe(2, camera=camera_4, zoom=1)
#anim.add_keyframe(5, camera=camera_6, zoom=1)
#anim.add_keyframe(7, camera=camera_7, zoom=1)
anim.add_keyframe(0, camera=camera_5, zoom=1)
#anim.add_keyframe(14, camera=three_quarters_camera_zoom, zoom=1.005)
anim.add_keyframe(2, camera=three_quarters_camera_zoom, zoom=1.005)
#anim.add_keyframe(14, camera=camera_2, zoom=1)

# Make videos
anim.make_video(duration=3, fps=96)

#anim.make_video(duration=10, fps=50)


#using VM instead of anim
#vm=VideoMaker(scene,"","vid_testingflicker_vm_fps100")
#vm.make_video(duration=3, elevation=0, azimuth=2, roll=0,fps=100)
